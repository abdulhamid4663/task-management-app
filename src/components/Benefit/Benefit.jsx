    ...
    return (
        <div className="max-w-screen-2xl mx-auto px-4 py-32">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 items-center mt-6 lg:mt-16 pb-6">
                <div data-aos="fade-right" className="flex lg:py-10 flex-col lg:px-20 justify-center order-2 md:order-1">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 items-center pb-6">
                ...
                <div data-aos="fade-left" className="flex lg:py-10 flex-col lg:px-20 justify-center order-2">
